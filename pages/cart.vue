<template>
  <div class="container mx-auto">
    ...
    <template v-if="!loading">
      ...
      <div v-if="pageIds.length === 0" class="mb-4 p-8 border rounded-md text-center">
        <div class="text-xl">購物車尚未有任何物品</div>
        <div class="flex justify-center">
          <nuxt-link to="/" class="btn-primary mt-4">瀏覽貨品</nuxt-link>
        </div>
      </div>
    </template>
